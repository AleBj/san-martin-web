    ...
    <div :class="$style.gridCards">
      <div v-for="(c, index) in items" :key="index" :class="[$style.cardthird]"> 
        ...
        <div :class="$style.paragraph">
          ...
          <nuxt-link v-if="c.link_boton_cardthird.url && c.link_boton_cardthird.link_type !== 'Web'" :to="`${c.link_boton_cardthird.url}`" :class="$style.button" :target="`${c.link_boton_cardthird.target}`">
