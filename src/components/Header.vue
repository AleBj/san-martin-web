  ...
  <header>
    ...
    <nav v-if="isOpen">
      ...
      <div :class="$style.navIcons" @click="close">
        ...
        <a href="https://api.whatsapp.com/send?phone=5491136858305&text=Quiero%20sumarme!" target="_blank" :class="$style.icon">
        ...
        <Button :cta="`Trámites`" :link="`/tramites`" :class="$style.button" />        
      </div>
    </nav>
